...
public class PropertyReqDTO {
    ...
    @Size(max = 30, message = "O nome da propriedade não pode ter mais de 30 caracteres.")
    private String propName;

    @NotBlank(message = "O nome do bairro não pode ser vazio.")
    @NotNull(message = "O nome do bairro não pode ser vazio.")
    @Size(max = 45, message = "O nome do bairro não pode ter mais de 45 caracteres.")
    private String propDistrict;

    @NotBlank(message = "O valor do metro quadrado no bairro não pode ser vazio.")
    @NotNull(message = "O valor do metro quadrado no bairro não pode ser nulo.")
    @Size(max = 13, message = "O valor do metro quadrado no bairro não pode ter mais de 13 caracteres.")
    ...
    @Size(max = 30, message = "O nome do cômodo não pode ter mais de 30 caracteres.")
